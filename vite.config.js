  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'what-we-do-block': path.resolve(__dirname, 'wp-content/themes/system-cars-theme/blocks/what-we-do-block/index.js'),
        'what-we-do-style': path.resolve(__dirname, 'wp-content/themes/system-cars-theme/blocks/what-we-do-block/style.scss'),
        'what-we-do-editor': path.resolve(__dirname, 'wp-content/themes/system-cars-theme/blocks/what-we-do-block/editor.scss'),
        'map-block': path.resolve(__dirname, 'wp-content/themes/system-cars-theme/blocks/map-block/index.js'),
        'map-style': path.resolve(__dirname, 'wp-content/themes/system-cars-theme/blocks/map-block/style.scss'),
        'contact-block': path.resolve(__dirname, 'wp-content/themes/system-cars-theme/blocks/contact-block/index.js'),
        'contact-frontend': path.resolve(__dirname, 'wp-content/themes/system-cars-theme/blocks/contact-block/frontend.js'),
        'contact-style': path.resolve(__dirname, 'wp-content/themes/system-cars-theme/blocks/contact-block/style.scss'),
