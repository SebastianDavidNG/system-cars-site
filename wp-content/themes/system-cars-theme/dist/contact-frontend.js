    ...
    form.addEventListener("submit", function(event) {
      ...
      fetch(config.ajaxUrl, {
        ...
        if (result.data && result.data.success) {
          setFeedback(
            feedback,
            result.data.data && result.data.data.message || form.dataset.success || "¡Gracias! Tu mensaje fue enviado correctamente.",
            "success"
          );
          form.reset();
        } else {
          const msg = result.data && result.data.data && result.data.data.message || form.dataset.error || "No se pudo enviar el mensaje. Inténtalo de nuevo.";
