    ...
    <div class="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="text-center md:text-left">
            ...
            <div class="flex space-x-3 justify-center md:justify-start">
                <a href="https://facebook.com" target="_blank" class="w-10 h-10 flex items-center justify-center bg-secondary rounded hover:bg-blue-600 transition">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a href="https://instagram.com" target="_blank" class="w-10 h-10 flex items-center justify-center bg-secondary rounded hover:bg-pink-500 transition">
                    <i class="fab fa-instagram"></i>
                </a>
                <a href="https://youtube.com" target="_blank" class="w-10 h-10 flex items-center justify-center bg-secondary rounded hover:bg-red-600 transition">
